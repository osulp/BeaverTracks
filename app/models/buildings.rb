# Building, main object for building information
class Buildings < ActiveRecord::Base
  attr_accessible :id, :description, :flickr_orig_url, :flickr_tag,
                  :flickr_thumb_url, :lat, :lng, :name, :search_tags
  ...
  def self.nearby(obj)
    Buildings.near(obj, 1)[0..3]  # 3 buildings and itself
  end
end
